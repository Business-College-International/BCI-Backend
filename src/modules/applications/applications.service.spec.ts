...
function makeTx(overrides: Record<string, unknown> = {}) { return { academicYear: { findUnique: jest.fn() }, term: { findUnique: jest.fn() }, schoolClass: { findUnique: jest.fn() }, enrolment: { count: jest.fn(), create: jest.fn() }, student: { findUnique: jest.fn(), create: jest.fn() }, user: { findUnique: jest.fn() }, person: { findFirst: jest.fn(), create: jest.fn() }, guardian: { upsert: jest.fn(), create: jest.fn() }, guardianStudent: { findUnique: jest.fn(), create: jest.fn() }, application: { updateMany: jest.fn() }, admissionDecisionRecord: { create: jest.fn() }, auditLog: { create: jest.fn() }, ...overrides }; }
